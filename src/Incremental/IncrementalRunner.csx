...
//
// #load "Incremental/IncrementalRunner.csx"
...
code.Append(@"namespace Microsoft.BuildPipeline.Incremental
{
    using System;
...
File.WriteAllText("Incremental/IncrementalRunner.g.cs", code.ToString());